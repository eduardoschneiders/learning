...
public class Main {
	...
	public static void main(String[] args) {
		...
		Calculadora resultadoModa = calcComplexa.moda(Util.generateIntegers(10, 1, 10));
		System.out.println(resultadoModa.operandos +  Double.toString(resultadoModa.resultado));
		
		Calculadora resultadoFatorial = calcComplexa.fatorial(Util.generateIntegers(1, 4, 4));
		System.out.println(resultadoFatorial.operandos +  Double.toString(resultadoFatorial.resultado));
	}
}
